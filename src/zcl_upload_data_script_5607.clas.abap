class zcl_upload_data_script_5607 definition
  public
  final
  create public .
...
class zcl_upload_data_script_5607 implementation.
...
*last_changed_at       : abp_lastchange_tstmpl;
    ...
    data: lt_acc_categ type table of ztacc_categ_5607,
          lt_catego    type table of ztb_catego_5607,
          lt_clientes  type table of ztclientes_5607,
          lt_clnts_lib type table of ztclnts_lib_5607,
          lt_libros    type table of ztb_libros_5607.
...
******** TABLA1 ********
    ...
    delete from ztacc_categ_5607.
    insert ztacc_categ_5607 from table @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_5607.
    insert ztb_catego_5607 from table @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztclientes_5607.
    insert ztclientes_5607 from table @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    delete from ztclnts_lib_5607.
    insert ztclnts_lib_5607 from table @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_5607.
    insert ztb_libros_5607 from table @lt_libros.
